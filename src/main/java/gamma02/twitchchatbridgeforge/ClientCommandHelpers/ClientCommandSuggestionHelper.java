...
public class ClientCommandSuggestionHelper extends CommandSuggestionHelper {
    ...
    public void init() {
        ...
        if(s.startsWith(TwitchChatBridgeForge.getMarker() + "")){
            ...
            boolean flag = stringreader.canRead() && (stringreader.peek() == TwitchChatBridgeForge.getMarker());
            if (flag) {
                stringreader.skip();
            }
            ...
            if (flag) {
                CommandDispatcher<ISuggestionProvider> commanddispatcher = (CommandDispatcher<ISuggestionProvider>)(CommandDispatcher<?>) TwitchChatBridgeForge.getDispatcher();
